            ...
            {isOpen && (
                <div className="dropdown-content">
                    {colors.options.map(color => (
                        ...
                        <div className="dropdown-item" onClick={() => { document.getElementById('noob').style.backgroundColor = color.value ; document.getElementById("label").innerHTML = color.label; document.getElementById('hehe').style.backgroundColor = color.value; }}>
                            {color.label}
                        </div>
                    ))}
